"""
D3QN (Double Dueling DQN) with Noisy Networks for OBELIX submission.
No PER - standard uniform replay.
"""
    ...
    for name in possible_names:
        ...
        if os.path.exists(path):
            try:
                ...
                print(f"Loaded D3QN+Noisy from {path}")
                return _NETWORK
