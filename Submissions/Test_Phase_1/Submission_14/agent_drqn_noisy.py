"""
DRQN-Noisy (Deep Recurrent Q-Network with Noisy Networks) Agent for OBELIX.

This agent loads pretrained LSTM+Noisy weights and uses them for evaluation.
...
class LSTMNoisyDQN(nn.Module):
    """LSTM-based DQN with Noisy output layer."""
...
def _load_once():
    ...
    m = LSTMNoisyDQN(in_dim=18, hidden_dim=64, n_actions=5)
