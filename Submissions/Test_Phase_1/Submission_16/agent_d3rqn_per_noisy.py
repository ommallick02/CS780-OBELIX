"""
D3RQN-PER-Noisy (Dueling Deep Recurrent Q-Network with PER and Noisy Networks) Agent for OBELIX.

This agent loads pretrained LSTM+Dueling+PER+Noisy weights and uses them for evaluation.
