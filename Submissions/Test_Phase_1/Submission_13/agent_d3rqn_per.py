"""
D3RQN-PER (Dueling Deep Recurrent Q-Network with PER) Agent with LSTM for OBELIX.

This agent loads pretrained LSTM+dueling weights and uses them for evaluation.
...
# Global state
_model: Optional[DuelingLSTMDQN] = None
...
def _load_once():
    ...
    m = DuelingLSTMDQN(in_dim=18, hidden_dim=64, n_actions=5)
